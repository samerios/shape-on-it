<?php
//include all functions from "function" file and the classes will be use in trainer GUI
include "../inc/function.php";
require_once ('../classes/Item.php');
require_once ('../classes/Orders.php');
require_once ('../classes/ShapeOnIt.php');
//start session to get "trainer" id and username by use the "checkStatus" function to check if the session active
session_start();
...
<html>
<head>
  <title>Shape On It | Trainer</title>
   <meta charset="utf-8" />
...
<div class="navbar">
  ...
  <a href="lessonSchedule.php">Watch Lessons schedule & sign up for lessons</a>
  <a href="WorkPlanDetails.php">Your workplan & nutrition menu</a>
  <a href="registerLessons.php">Your Lessons</a>
