...
w2utils.formatters = {
        ...
        a.fn.w2render = function(b) {
            ...
            function e(b) {
                if (!b || 0 === b.button) {
                    ...
                    if (!b || a(a(b.target).closest(".w2ui-overlay").data("element")).closest(".w2ui-overlay")[0] !== d[0]) {
            ...
            var l = function(c, d) {
                ...
                q = function(a) {
                    ...
                    e < -g && (e = -g), f < -g && (f = -g),
                        e > i.width - g && (e = i.width - g), f > i.height - g && (f = i.height - g), b.hasClass("move-x") && b.css({
                            left: e + "px"
    ...
    function($) {
        var w2grid = function(a) {
            this.name = null, this.box = null, this.columns = [], this.columnGroups = [], this.records = [], this.summary = [], this.searches = [], this.sortMap = {}, this.toolbar = {}, this.total = 0, this.recid = null, this.last = {
                field: "",
                label: "",
                logic: "OR",
                search: "",
        ...
        $.fn.w2grid = function(a) {
            if ($.isPlainObject(a)) {
                ...
                var i;
                if (b)
                    for (i = 0; i < b.length; i++) h.columns[i] = $.extend(!0, {}, b[i]);
                if (c)
                    for (i = 0; i < c.length; i++) h.columnGroups[i] = $.extend(!0, {}, c[i]);
                if (e)
                    for (i = 0; i < e.length; i++) h.searches[i] = $.extend(!0, {}, e[i]);
                if (f)
                    for (i = 0; i < f.length; i++) h.searchData[i] = $.extend(!0, {}, f[i]);
                if (g)
                    for (i = 0; i < g.length; i++) h.sortData[i] = $.extend(!0, {}, g[i]);
                if (d)
                    for (var j = 0; j < d.length; j++) {
                        if (null == d[j].recid && null == d[j][h.recid]) return void console.log("ERROR: Cannot add records without recid. (obj: " + h.name + ")");
                        h.records[j] = $.extend(!0, {}, d[j])
                    }
                for (var k = 0; k < h.columns.length; k++) {
                    var l = h.columns[k],
                        m = l.searchable;
                    if (null != m && m !== !1 && null == h.getSearch(l.field))
                        if ($.isPlainObject(m)) h.addSearch($.extend({
                            field: l.field,
                            label: l.text,
                            type: "text"
                        }, m));
                            ...
                            var n = l.searchable,
                                o = "";
                            l.searchable === !0 && (n = "text", o = 'size="20"'), h.addSearch({
                                field: l.field,
                                label: l.text,
                                type: n,
                                attr: o
                ...
                return h.initToolbar(), h.updateToolbar(), 0 !== $(this).length && h.render($(this)[0]), w2ui[h.name] = h, h
            }
            var p = w2ui[$(this).attr("name")];
            return p ? arguments.length > 0 ? (p[a] && p[a].apply(p, Array.prototype.slice.call(arguments, 1)), this) : p : null
        }, w2grid.prototype = {
            header: "",
            url: "",
            limit: 100,
                    ...
                    c.columns.forEach(function(c) {
                        if (c.field == a) {
                            ...
                            Object.keys(e).forEach(function(a) {
                                "function" == typeof e[a] && (e[a] = e[a](c)), c[a] != e[a] && d++
                            }), $.extend(!0, c, e)
                        }
                    })
                }), this.refreshBody(), this.resizeRecords(), d
            },
                ...
                if (this.total = this.records.length, this.last.searchIds = [], this.prepareData(), this.searchData.length > 0 && !d) {
                    ...
                    for (var i = 0; i < this.records.length; i++) {
                        var j = this.records[i],
                            k = b(j);
                        if (k)
                            if (j && j.w2ui && c(j.w2ui.parent_recid), this.showExtraOnSearch > 0) {
                                var l = this.showExtraOnSearch,
                                    m = this.showExtraOnSearch;
                        ...
                        if ("selection" != i.name || i.range[0].recid != w || i.range[0].column != x) {
                            ...
                            if (n.length > 0 || o.length > 0)
                                if (0 === y.length ? (f.append('<div id="grid_' + this.name + "_f" + i.name + '" class="w2ui-selection" style="' + i.style + '">' + ("selection" == i.name ? '<div id="grid_' + this.name + '_resizer" class="w2ui-selection-resizer"></div>' : "") + "</div>"), y = $("#grid_" + this.name + "_f" + i.name)) : (y.attr("style", i.style), y.find(".w2ui-selection-resizer").show()), 0 === o.length && (o = $("#grid_" + this.name + "_frec_" + w2utils.escapeId(k.recid) + " td:last-child"), 0 === o.length && (o = $("#grid_" + this.name + "_frec_bottom td:first-child")), y.css("border-right", "0px"), y.find(".w2ui-selection-resizer").hide()), null != j.recid && null != k.recid && n.length > 0 && o.length > 0) {
                                    var z = n.position().left - 0 + f.scrollLeft(),
                                        A = n.position().top - 0 + f.scrollTop();
                                    y.show().css({
                                        left: (z > 0 ? z : 0) + "px",
                                        top: (A > 0 ? A : 0) + "px",
                                        width: o.position().left - n.position().left + o.width() + 2 + "px",
                                        height: o.position().top - n.position().top + o.height() + 1 + "px"
                                    })
                                } else y.hide();
                            else y.hide();
                            ...
                            if (l.length > 0 || m.length > 0)
                                if (0 === y.length ? (g.append('<div id="grid_' + this.name + "_" + i.name + '" class="w2ui-selection" style="' + i.style + '">' + ("selection" == i.name ? '<div id="grid_' + this.name + '_resizer" class="w2ui-selection-resizer"></div>' : "") + "</div>"), y = $("#grid_" + this.name + "_" + i.name)) : y.attr("style", i.style), 0 === l.length && (l = $("#grid_" + this.name + "_rec_" + w2utils.escapeId(j.recid) + " td:first-child"), 0 === l.length && (l = $("#grid_" + this.name + "_rec_top td:first-child"))), 0 !== o.length && y.css("border-left", "0px"), null != j.recid && null != k.recid && l.length > 0 && m.length > 0) {
                                    var z = l.position().left - 0 + g.scrollLeft(),
                                        A = l.position().top - 0 + g.scrollTop();
                                    y.show().css({
                                        left: (z > 0 ? z : 0) + "px",
                                        top: (A > 0 ? A : 0) + "px",
                                        width: m.position().left - l.position().left + m.width() + 2 + "px",
                                        height: m.position().top - l.position().top + m.height() + 1 + "px"
                                    })
                                } else y.hide();
                            else y.hide()
                        }
            ...
            select: function() {
                ...
                return r || s ? $("#grid_" + this.name + "_check_all").prop("checked", !0) : $("#grid_" + this.name + "_check_all").prop("checked", !1), this.status(), this.addRange("selection"), this.updateToolbar(b, r), this.trigger($.extend(d, {
                    phase: "after"
                })), a
            },
            unselect: function() {
                ...
                return q || r ? $("#grid_" + this.name + "_check_all").prop("checked", !0) : $("#grid_" + this.name + "_check_all").prop("checked", !1), this.status(), this.addRange("selection"), this.updateToolbar(b, q), a
            },
            selectAll: function() {
                ...
                if (this.multiSelect !== !1) {
                    ...
                    if (b.isCancelled !== !0) {
                        ...
                        return 1 == d.length ? this.toolbar.enable("w2ui-edit") : this.toolbar.disable("w2ui-edit"), d.length >= 1 ? this.toolbar.enable("w2ui-delete") : this.toolbar.disable("w2ui-delete"), this.addRange("selection"), $("#grid_" + this.name + "_check_all").prop("checked", !0), this.status(), this.updateToolbar({
                            indexes: d
                        }, !0), this.trigger($.extend(b, {
                            phase: "after"
                        })), (new Date).getTime() - a
                    }
                }
            ...
            updateToolbar: function(a, b) {
                function c(b, c) {
                    0 === b.batch && (e > 0 ? d.toolbar.enable(c + b.id) : d.toolbar.disable(c + b.id)), null != b.batch && !isNaN(b.batch) && b.batch > 0 && (e == b.batch ? d.toolbar.enable(c + b.id) : d.toolbar.disable(c + b.id)), "function" == typeof b.batch && b.batch("cell" == d.selectType ? a : a ? a.indexes : null)
                }
                var d = this,
                    e = a && a.indexes ? a.indexes.length : 0;
                this.toolbar.items.forEach(function(a) {
                    c(a, ""), Array.isArray(a.items) && a.items.forEach(function(b) {
                        c(b, a.id + ":")
                    })
                })
            },
            ...
            search: function(a, b) {
                for (var c = "object" != typeof this.url ? this.url : this.url.get, d = [], e = this.last.multi, f = this.last.logic, g = this.last.field, h = this.last.search, i = !1, j = 0; j < this.searches.length; j++) this.searches[j].hidden && null != this.searches[j].value && (d.push({
                            ...
                            for (var j = 0; j < this.searches.length; j++) {
                                ...
                                for (var j = 0; j < this.columns.length; j++) {
                                    ...
                                    if (null == k && (k = {
                                            field: a,
                                            type: "text"
                                        }), k.field == a && (this.last.label = k.label), "" !== b) {
            ...
            searchReset: function(a) {
                for (var b = [], c = !1, d = 0; d < this.searches.length; d++) this.searches[d].hidden && null != this.searches[d].value && (b.push({
                ...
                if (e.isCancelled !== !0) {
                    if (this.searchData = e.searchData, this.last.search = "", this.last.logic = c ? "AND" : "OR", this.searches.length > 0)
                        if (this.multiSearch && this.show.searchAll) this.last.field = "all", this.last.label = w2utils.lang("All Fields");
                        else {
                            for (var f = 0; f < this.searches.length && (this.searches[f].hidden || this.searches[f].simple === !1);) f++;
                            f >= this.searches.length ? (this.last.field = "", this.last.label = "") : (this.last.field = this.searches[f].field, this.last.label = this.searches[f].label)
                        }
            ...
            searchShowFields: function() {
                for (var a = this, b = $("#grid_" + this.name + "_search_all"), c = '<div class="w2ui-select-field"><table><tbody>', d = -1; d < this.searches.length; d++) {
                    ...
                    if (d == -1) {
                        ...
                        if (null != f && f.hideable === !1) continue;
                        if (this.searches[d].hidden === !0 || this.searches[d].simple === !1) continue
                    }
                    null == e.label && null != e.caption && (console.log("NOTICE: grid search.caption property is deprecated, please use search.label. Search ->", e), e.label = e.caption), c += "<tr " + (w2utils.isIOS ? "onTouchStart" : "onClick") + "=\"w2ui['" + this.name + "'].initAllField('" + e.field + "');      event.stopPropagation(); jQuery('#grid_" + this.name + "_search_all').w2overlay({ name: '" + this.name + '-searchFields\' });">   <td>       <span class="w2ui-column-check w2ui-icon-' + (e.field == this.last.field ? "check" : "empty") + '"></span>   </td>   <td>' + e.label + "</td></tr>"
                }
            ...
            initAllField: function(a, b) {
                ...
                "" != this.last.search ? (this.last.label = d.label, this.search(d.field, this.last.search)) : (this.last.field = d.field, this.last.label = d.label), c.attr("placeholder", w2utils.lang(d.label || d.caption || d.field)), $().w2overlay({
            ...
            request: function(a, b, c, d) {
                if (null == b && (b = {}), "" != c && null != c || (c = this.url), "" != c && null != c) {
                    w2utils.isInt(this.offset) || (this.offset = 0), w2utils.isInt(this.last.xhr_offset) || (this.last.xhr_offset = 0);
                    var e = {
                        limit: this.limit,
                        offset: parseInt(this.offset) + parseInt(this.last.xhr_offset),
                        searchLogic: this.last.logic,
                        search: this.searchData.map(function(a) {
                            var b = $.extend({}, a);
                            return this.searchMap && this.searchMap[b.field] && (b.field = this.searchMap[b.field]), b
                        }.bind(this)),
                        sort: this.sortData.map(function(a) {
                            var b = $.extend({}, a);
                            return this.sortMap && this.sortMap[b.field] && (b.field = this.sortMap[b.field]), b
                        }.bind(this))
                    };
                    if (0 === this.searchData.length && (delete e.search, delete e.searchLogic), 0 === this.sortData.length && delete e.sort, $.extend(e, this.postData), $.extend(e, b), "get" == a) {
                        var f = this.trigger({
                            phase: "before",
                            type: "request",
                            target: this.name,
                        ...
                        if ("" != this.msgDelete && !a) return void this.message({
                            ...
                            onOpen: function(a) {
                                ...
                                c.off(".message").on("blur.message", function(a) {
                                    ...
                                    $(this.box).find(".w2ui-btn.btn-default").focus(), clearTimeout(b.last.kbd_timer)
                                }.bind(this), 50)
                            }
                        });
            ...
            focus: function(a) {
                ...
                return c.isCancelled !== !0 && (this.hasFocus = !0, $(this.box).removeClass("w2ui-inactive").find(".w2ui-inactive").removeClass("w2ui-inactive"), setTimeout(function() {
            ...
            blur: function(a) {
                ...
                return b.isCancelled !== !0 && (this.hasFocus = !1, $(this.box).addClass("w2ui-inactive").find(".w2ui-selected").addClass("w2ui-inactive"), $(this.box).find(".w2ui-selection").addClass("w2ui-inactive"), void this.trigger($.extend(b, {
                    phase: "after"
                })))
            },
            keydown: function(a) {
                ...
                if (d.keyboard === !0) {
                    ...
                    if (f.isCancelled !== !0) {
                        ...
                        switch (r) {
                            case 8:
                            case 46:
                                d.delete(), q = !0, a.stopPropagation();
                                break;
                            case 27:
                                d.selectNone(), q = !0;
                                break;
                            ...
                            case 13:
                                if ("row" == this.selectType && d.show.expandColumn === !0) {
                                    ...
                                    "row" == this.selectType && this.last._edit && this.last._edit.column && (k = [this.last._edit.column]), k.length > 0 && (d.editField(j, k[0], null, a), q = !0)
                                }
                                break;
                            case 37:
                                if (g) {
            ...
            copy: function(a, b) {
                ...
                if ("object" == typeof c[0]) {
                    ...
                    for (var k = 0; k < this.columns.length; k++) {
                        var l = this.columns[k];
                        if (l.hidden !== !0) {
                            var m = l.text ? l.text : l.field;
                            l.text && l.text.length < 3 && l.tooltip && (m = l.tooltip), d += '"' + w2utils.stripTags(m) + '"\t'
                        }
                    }
                    d = d.substr(0, d.length - 1), d += "\n";
            ...
            refresh: function() {
                ...
                if (this.total <= 0 && !c && 0 === this.searchData.length && (this.total = this.records.length), this.toolbar.disable("w2ui-edit", "w2ui-delete"), this.box) {
                    ...
                    if (d.isCancelled !== !0) {
                        ...
                        !this.multiSearch && "all" == this.last.field && this.searches.length > 0 && (this.last.field = this.searches[0].field, this.last.label = this.searches[0].label);
                        for (var h = 0; h < this.searches.length; h++) this.searches[h].field == this.last.field && (this.last.label = this.searches[h].label);
                        if (this.last.multi ? (g.attr("placeholder", "[" + w2utils.lang("Multiple Fields") + "]"), g.w2field("clear")) : g.attr("placeholder", w2utils.lang(this.last.label)), g.val() != this.last.search) {
            ...
            render: function(a) {
                ...
                var e = this,
                    f = (new Date).getTime();
                if (null != a && ($(this.box).find("#grid_" + this.name + "_body").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-grid w2ui-inactive").html(""), this.box = a), this.box) {
                    var g = "object" != typeof this.url ? this.url : this.url.get,
                        h = this.trigger({
                            phase: "before",
                            target: this.name,
                    ...
                    if (h.isCancelled !== !0) {
                        if (this.reset(!0), !this.last.field)
                            if (this.multiSearch && this.show.searchAll) this.last.field = "all", this.last.label = w2utils.lang("All Fields");
                                ...
                                i >= this.searches.length ? (this.last.field = "", this.last.label = "") : (this.last.field = this.searches[i].field, this.last.label = this.searches[i].label)
                            }
                        ...
                        $("#grid_" + this.name + "_footer").html(this.getFooterHTML()), this.last.state || (this.last.state = this.stateSave(!0)), this.stateRestore(), g && (this.clear(), this.refresh());
                        ...
                        var m;
                        return $(this.box).on("mousedown", b), this.updateToolbar(), this.trigger($.extend(h, {
                            phase: "after"
            ...
            destroy: function() {
                ...
                a.isCancelled !== !0 && ($(this.box).off(), "object" == typeof this.toolbar && this.toolbar.destroy && this.toolbar.destroy(), $(this.box).find("#grid_" + this.name + "_body").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-grid w2ui-inactive").html(""), delete w2ui[this.name], this.trigger($.extend(a, {
                    phase: "after"
                })))
            },
            ...
            initToolbar: function() {
                ...
                if (null == this.toolbar.render) {
                    ...
                    if (this.show.toolbarSearch && this.multiSearch && this.searches.length > 0 && this.toolbar.items.push($.extend(!0, {}, this.buttons["search-go"])), (this.show.toolbarSearch || this.show.toolbarInput) && (this.show.toolbarAdd || this.show.toolbarEdit || this.show.toolbarDelete || this.show.toolbarSave) && this.toolbar.items.push({
                            type: "break",
                            id: "w2ui-break1"
                        }), this.show.toolbarAdd && Array.isArray(b) && b.map(function(a) {
                            return a.id
                        }).indexOf(this.buttons.add.id) == -1 && this.toolbar.items.push($.extend(!0, {}, this.buttons.add)), this.show.toolbarEdit && Array.isArray(b) && b.map(function(a) {
                            return a.id
                        }).indexOf(this.buttons.edit.id) == -1 && this.toolbar.items.push($.extend(!0, {}, this.buttons.edit)), this.show.toolbarDelete && Array.isArray(b) && b.map(function(a) {
                            return a.id
                        }).indexOf(this.buttons.delete.id) == -1 && this.toolbar.items.push($.extend(!0, {}, this.buttons.delete)), this.show.toolbarSave && Array.isArray(b) && b.map(function(a) {
                            return a.id
                        }).indexOf(this.buttons.save.id) == -1 && ((this.show.toolbarAdd || this.show.toolbarDelete || this.show.toolbarEdit) && this.toolbar.items.push({
                            type: "break",
                            id: "w2ui-break2"
                    ...
                    }), this.toolbar.on("refresh", function(b) {
                        if ("w2ui-search" == b.target) {
                            var c = a.searchData;
                            setTimeout(function() {
                                a.initAllField(a.last.field, 1 == c.length ? c[0].value : null)
                            }, 1)
                        }
                    })
                }
            ...
            getSearchesHTML: function() {
                ...
                for (var b = this, c = '<table cellspacing="0"><tbody>', d = !1, e = 0; e < this.searches.length; e++) {
                    ...
                    if (f.type = String(f.type).toLowerCase(), !f.hidden) {
                        var g = "";
                        0 == d && (g = '<button type="button" class="w2ui-btn close-btn" onclick="obj = w2ui[\'' + this.name + "']; if (obj) obj.searchClose()\">X</button>", d = !0), null == f.inTag && (f.inTag = ""), null == f.outTag && (f.outTag = ""), null == f.style && (f.style = ""), null == f.type && (f.type = "text"), null == f.label && null != f.caption && (console.log("NOTICE: grid search.caption property is deprecated, please use search.label. Search ->", f), f.label = f.caption);
                        ...
                        switch (c += '<tr>    <td class="close-btn">' + g + '</td>    <td class="caption">' + (f.label || "") + '</td>    <td class="operator">' + h + '</td>    <td class="value">', f.type) {
                            case "text":
                            case "alphanumeric":
                            case "hex":
                            case "color":
                        ...
                        case "select":
                            for (var i = '<option value="">--</option>', g = 0; g < c.options.items.length; g++) {
                                ...
                                if ($.isPlainObject(c.options.items[g])) {
                                    var k = j.id,
                                        l = j.text;
                                    null == k && null != j.value && (k = j.value), null == l && null != j.text && (l = j.text), null == k && (k = ""), i += '<option value="' + k + '">' + l + "</option>"
            ...
            getColumnsHTML: function() {
                function a() {
                    var a = "<tr>",
                        b = "<tr>",
                        d = "",
                        e = c.columnGroups.length - 1;
                    null == c.columnGroups[e].text && null != c.columnGroups[e].caption && (console.log("NOTICE: grid columnGroup.caption property is deprecated, please use columnGroup.text. Group -> ", c.columnGroups[e]), c.columnGroups[e].text = c.columnGroups[e].caption), "" != c.columnGroups[c.columnGroups.length - 1].text && c.columnGroups.push({
                        text: ""
                    ...
                    for (var g = 0; g < c.columnGroups.length; g++) {
                        var h = c.columnGroups[g],
                            i = c.columns[f];
                        null != h.colspan && (h.span = h.colspan), null != h.span && h.span == parseInt(h.span) || (h.span = 1), null == i.text && null != i.caption && (console.log("NOTICE: grid column.caption property is deprecated, please use column.text. Column ->", i), i.text = i.caption);
                        for (var j = 0, k = f; k < f + h.span; k++) c.columns[k] && !c.columns[k].hidden && j++;
                        if (g == c.columnGroups.length - 1 && j++, j <= 0);
                        else if (h.master === !0) {
                            for (var l = "", m = 0; m < c.sortData.length; m++) c.sortData[m].field == i.field && ("asc" === (c.sortData[m].direction || "").toLowerCase() && (l = "w2ui-sort-up"), "desc" === (c.sortData[m].direction || "").toLowerCase() && (l = "w2ui-sort-down"));
                            var n = "";
                            i.resizable !== !1 && (n = '<div class="w2ui-resizer" name="' + f + '"></div>'), d = '<td id="grid_' + c.name + "_column_" + f + '" class="w2ui-head ' + l + '" col="' + f + '"     rowspan="2" colspan="' + j + '"     oncontextmenu = "w2ui[\'' + c.name + "'].contextMenu(null, " + f + ', event);"    onclick="w2ui[\'' + c.name + "'].columnClick('" + i.field + "', event);\"    ondblclick=\"w2ui['" + c.name + "'].columnDblClick('" + i.field + "', event);\">" + n + '    <div class="w2ui-col-group w2ui-col-header ' + (l ? "w2ui-col-sorted" : "") + '">        <div class="' + l + '"></div>' + (i.text ? i.text : "&#160;") + "    </div></td>", i && i.frozen ? a += d : b += d
                        } else d = '<td id="grid_' + c.name + "_column_" + f + '" class="w2ui-head" col="' + f + '"         colspan="' + j + '">    <div class="w2ui-col-group">' + (h.text ? h.text : "&#160;") + "    </div></td>", i && i.frozen ? a += d : b += d;
                        f += h.span
                    }
                ...
                function b(a) {
                    ...
                    for (var h = 0; h < c.columns.length; h++) {
                        var i = c.columns[h];
                        if (null == i.text && null != i.caption && (console.log("NOTICE: grid column.caption property is deprecated, please use column.text. Column -> ", i), i.text = i.caption), null == i.size && (i.size = "100%"), h == g && (e = c.columnGroups[f++] || {}, g += e.span), (!(h < c.last.colStart || h > c.last.colEnd) || i.frozen) && !i.hidden && (e.master !== !0 || a)) {
            ...
            getRecordHTML: function(a, b, c) {
                ...
                if (!d) return "";
                if (null == d.recid && null != this.recid) {
                    var l = this.parseField(d, this.recid);
                    null != l && (d.recid = l)
                }
                var m = (w2utils.escapeId(d.recid), !1);
                h.indexes.indexOf(a) != -1 && (m = !0);
                var n = d.w2ui ? d.w2ui.style : "";
                null != n && "string" == typeof n || (n = "");
                var o = d.w2ui ? d.w2ui.class : "";
                if (null != o && "string" == typeof o || (o = ""), f += '<tr id="grid_' + this.name + "_frec_" + d.recid + '" recid="' + d.recid + '" line="' + b + '" index="' + a + '"  class="' + (b % 2 === 0 ? "w2ui-even" : "w2ui-odd") + " w2ui-record " + o + (m && "row" == this.selectType ? " w2ui-selected" : "") + (d.w2ui && d.w2ui.editable === !1 ? " w2ui-no-edit" : "") + (d.w2ui && d.w2ui.expanded === !0 ? " w2ui-expanded" : "") + '" ' + (c !== !0 ? w2utils.isIOS ? "    onclick  = \"w2ui['" + this.name + "'].dblClick(jQuery(this).attr('recid'), event);\"" : "    onclick  = \"w2ui['" + this.name + "'].click(jQuery(this).attr('recid'), event);\"    oncontextmenu = \"w2ui['" + this.name + "'].contextMenu(jQuery(this).attr('recid'), null, event);\"" : "") + ("row" == this.selectType ? " onmouseover=\"jQuery('#grid_" + this.name + "_rec_'+ w2utils.escapeId(jQuery(this).attr('recid'))).addClass('w2ui-record-hover')\" onmouseout =\"jQuery('#grid_" + this.name + "_rec_'+ w2utils.escapeId(jQuery(this).attr('recid'))).removeClass('w2ui-record-hover')\"" : "") + ' style="height: ' + this.recordHeight + "px; " + (m || "" == n ? n.replace("background-color", "none") : n) + '" ' + ("" != n ? 'custom_style="' + n + '"' : "") + ">", g += '<tr id="grid_' + this.name + "_rec_" + d.recid + '" recid="' + d.recid + '" line="' + b + '" index="' + a + '"  class="' + (b % 2 === 0 ? "w2ui-even" : "w2ui-odd") + " w2ui-record " + o + (m && "row" == this.selectType ? " w2ui-selected" : "") + (d.w2ui && d.w2ui.editable === !1 ? " w2ui-no-edit" : "") + (d.w2ui && d.w2ui.expanded === !0 ? " w2ui-expanded" : "") + '" ' + (c !== !0 ? w2utils.isIOS ? "    onclick  = \"var obj = w2ui['" + this.name + "']; obj.dblClick(jQuery(this).attr('recid'), event);\"" : "    onclick  = \"var obj = w2ui['" + this.name + "']; obj.click(jQuery(this).attr('recid'), event);\"    oncontextmenu = \"var obj = w2ui['" + this.name + "']; obj.contextMenu(jQuery(this).attr('recid'), null, event);\"" : "") + ("row" == this.selectType ? " onmouseover=\"jQuery('#grid_" + this.name + "_frec_' + w2utils.escapeId(jQuery(this).attr('recid'))).addClass('w2ui-record-hover')\" onmouseout =\"jQuery('#grid_" + this.name + "_frec_' + w2utils.escapeId(jQuery(this).attr('recid'))).removeClass('w2ui-record-hover')\"" : "") + ' style="height: ' + this.recordHeight + "px; " + (m || "" == n ? n.replace("background-color", "none") : n) + '" ' + ("" != n ? 'custom_style="' + n + '"' : "") + ">", this.show.lineNumbers && (f += '<td id="grid_' + this.name + "_cell_" + a + "_number" + (c ? "_s" : "") + '"    class="w2ui-col-number ' + (m ? " w2ui-row-selected" : "") + '"' + (this.reorderRows ? ' style="cursor: move"' : "") + ">" + (c !== !0 ? this.getLineHTML(b, d) : "") + "</td>"), this.show.selectColumn) {
                    var p = !1;
                    d && d.w2ui && d.w2ui.hideCheckBox === !0 && (p = !0), f += '<td id="grid_' + this.name + "_cell_" + a + "_select" + (c ? "_s" : "") + '" class="w2ui-grid-data w2ui-col-select">' + (c === !0 || d.w2ui && d.w2ui.hideCheckBox === !0 ? "" : '    <div>        <input class="w2ui-grid-select-check" type="checkbox" tabindex="-1" ' + (m ? 'checked="checked"' : "") + ' style="pointer-events: none"/>    </div>') + "</td>"
                }
                if (this.show.expandColumn) {
                    var q = "";
                    q = d.w2ui && d.w2ui.expanded === !0 ? "-" : "+", d.w2ui && "none" == d.w2ui.expanded && (q = ""), d.w2ui && "spinner" == d.w2ui.expanded && (q = '<div class="w2ui-spinner" style="width: 16px; margin: -2px 2px;"></div>'), f += '<td id="grid_' + this.name + "_cell_" + a + "_expand" + (c ? "_s" : "") + '" class="w2ui-grid-data w2ui-col-expand">' + (c !== !0 ? '    <div ondblclick="if (event.stopPropagation) event.stopPropagation(); else event.cancelBubble = true;"             onclick="w2ui[\'' + this.name + "'].toggle(jQuery(this).parents('tr').attr('recid'));                 if (event.stopPropagation) event.stopPropagation(); else event.cancelBubble = true;\">        " + q + " </div>" : "") + "</td>";
                }
                ...
                for (var r = 0, s = 0;;) {
                    ...
                    if (j.hidden) r++, s > 0 && s--;
                        ...
                        if (r++, null == this.columns[r]) break;
                        d.w2ui.colspan[this.columns[r - 1].field] = 0, s--
                    } else {
                        if (d.w2ui) {
                            var u = d.w2ui.colspan,
                                v = this.columns[r].field;
                            u && 0 === u[v] && delete u[v]
                        }
                        if (!(r < this.last.colStart || r > this.last.colEnd) || j.frozen) {
                            if (d.w2ui && "object" == typeof d.w2ui.colspan) {
                                var w = parseInt(d.w2ui.colspan[j.field]) || null;
                                if (w > 1) {
                                    for (var x = 0, i = r; i < r + w && !(i >= this.columns.length); i++) this.columns[i].hidden && x++;
                                    t = w - x, s = w - 1
                                }
                            }
                            var y = this.getCellHTML(a, r, c, t);
                            j.frozen ? f += y : g += y, r++
                        } else r++
                    }
                }
            ...
            getCellHTML: function(a, b, c, d) {
                ...
                if (e.info === !0 && (e.info = {}), null != e.info) {
                    var t = "w2ui-icon-info";
                    "function" == typeof e.info.icon ? t = e.info.icon(f) : "object" == typeof e.info.icon ? t = e.info.icon[this.parseField(f, e.field)] || "" : "string" == typeof e.info.icon && (t = e.info.icon);
                    var u = e.info.style || "";
                    "function" == typeof e.info.style ? u = e.info.style(f) : "object" == typeof e.info.style ? u = e.info.style[this.parseField(f, e.field)] || "" : "string" == typeof e.info.style && (u = e.info.style), o += '<span class="w2ui-info ' + t + '" style="' + u + '" ' + (null != e.info.showOn ? "on" + e.info.showOn : "click") + "=\"event.stopPropagation(); w2ui['" + this.name + "'].showBubble(" + a + ", " + b + ')"' + (null != e.info.hideOn ? "on" + e.info.hideOn : "") + "=\"var grid = w2ui['" + this.name + "']; if (grid.last.bubbleEl) { $(grid.last.bubbleEl).w2tag() } grid.last.bubbleEl = null;\"></span>"
                }
                if (null != e.render && a !== -1) {
                    if ("function" == typeof e.render) {
                        var v = e.render.call(this, f, a, b, g);
                        null != v && "object" == typeof v ? (g = $.trim(v.html || ""), l = v.class || "", k = v.style || "") : g = $.trim(v), (g.length < 4 || "<div" != g.substr(0, 4).toLowerCase()) && (g = '<div style="' + i + '">' + o + String(g) + "</div>")
                    }
                    if ("object" == typeof e.render) {
                        var w = e.render[g];
                        null != w && "" !== w || (w = g), g = '<div style="' + i + '">' + o + w + "</div>"
                    }
                    if ("string" == typeof e.render) {
                        var x = e.render.toLowerCase().indexOf(":"),
                            r = [];
                        x == -1 ? (r[0] = e.render.toLowerCase(), r[1] = "") : (r[0] = e.render.toLowerCase().substr(0, x), r[1] = e.render.toLowerCase().substr(x + 1));
                        var y = w2utils.formatters[r[0]];
                        g = '<div style="' + i + '">' + o + ("function" == typeof y ? y(g, r[1]) : "") + "</div>"
                    }
                } else {
                    if (h && ["checkbox", "check"].indexOf(h.type) != -1) {
                        var z = c ? -(a + 1) : a;
                        i += "text-align: center;", g = '<input tabindex="-1" type="checkbox" ' + (g ? 'checked="checked"' : "") + " onclick=\"    var obj = w2ui['" + this.name + "'];     obj.editChange.call(obj, this, " + z + ", " + b + ', event); "/>', o = ""
                    }
                    if (this.show.recordTitles) {
                        var A = w2utils.stripTags(String(g).replace(/"/g, "''"));
                        null != e.title && ("function" == typeof e.title && (A = e.title.call(this, f, a, b)), "string" == typeof e.title && (A = e.title))
                    }
                    g = '<div style="' + i + '" title="' + (A || "") + '">' + o + String(g) + "</div>"
                }
                ...
                var B = !1;
                return n && $.inArray(b, m.columns[a]) != -1 && (B = !0), g = '<td class="w2ui-grid-data' + (B ? " w2ui-selected" : "") + " " + l + (j ? " w2ui-changed" : "") + '"    id="grid_' + this.name + "_data_" + a + "_" + b + '" col="' + b + '"    style="' + k + (null != e.style ? e.style : "") + '" ' + (null != e.attr ? e.attr : "") + (d > 1 ? 'colspan="' + d + '"' : "") + ">" + g + "</td>", a === -1 && c === !0 && (g = '<td class="w2ui-grid-data" col="' + b + '" style="height: 0px; ' + k + '" ' + (d > 1 ? 'colspan="' + d + '"' : "") + "></td>"), g
            },
                ...
                if ("function" == typeof i && (i = i(e, a, b)), "function" == typeof d.render) c = d.render(e, a, b);
                    ...
                    for (var g = 0; g < i.length; g++) {
                        ...
                        if ("" != j[0] && "-" != j[0] && "--" != j[0] && "---" != j[0]) {
                            ...
                            j.length > 1 && (w2utils.formatters[j[1]] ? k = w2utils.formatters[j[1]](k, j[2] || null) : console.log('ERROR: w2utils.formatters["' + j[1] + '"] does not exists.')), (d.showEmpty === !0 || null != k && "" != k) && (null != d.maxLength && "string" == typeof k && k.length > d.maxLength && (k = k.substr(0, d.maxLength) + "..."), c += "<tr><td>" + h.text + "</td><td>" + ((0 === k ? "0" : k) || "") + "</td></tr>")
            ...
            stateSave: function(a) {
                ...
                for (var c, d = {
                    ...
                    var f = b.columns[e],
                        g = {};
                    Object.keys(b.stateColProps).forEach(function(a, d) {
                        b.stateColProps[a] && (c = void 0 !== f[a] ? f[a] : b.stateColDefaults[a] || null, g[a] = c)
                    }), d.columns.push(g)
                }
    ...
    function(a) {
        ...
        a.fn.w2layout = function(d) {
            ...
            content: function(a, b, c) {
                return console.log("NOTICE: layout.content method is deprecated, please use layout.html() instead"), this.html(a, b, c)
            },
            html: function(b, c, d) {
                var e = this,
                    f = this.get(b),
                    g = {
                        ...
                        cancelled: !1,
                        removed: function(a) {
                            "function" == typeof a && (f.callBack = a)
                        }
                    };
                if ("function" == typeof f.callBack && (f.callBack({
                        panel: b,
                        content: f.content,
                        new_content: c,
                        transition: d || "none"
                    }), f.callBack = null), "css" == b) return a("#layout_" + e.name + "_panel_css").html("<style>" + c + "</style>"), g.status = !0, g;
                if (null == f) return console.log("ERROR: incorrect panel name. Panel name can be main, left, right, top, bottom, preview or css"), g.error = !0, g;
                if (null == c) return g;
                var h = this.trigger({
                    phase: "before",
                    type: "content",
                ...
                if (h.isCancelled === !0) return g.cancelled = !0, g;
                if (c instanceof jQuery) return console.log("ERROR: You can not pass jQuery object to w2layout.content() method"), g;
                var i = "#layout_" + this.name + "_panel_" + f.type,
                    j = a(i + "> .w2ui-panel-content"),
                    k = 0;
                if (j.length > 0 && (a(i).scrollTop(0), k = a(j).position().top), "" === f.content) f.content = c, this.refresh(b);
                else {
                    if (f.content = c, !f.hidden && null != d && "" !== d) {
                        var l = a(i + "> .w2ui-panel-content");
                        l.after('<div class="w2ui-panel-content new-panel" style="' + l[0].style.cssText + '"></div>');
                        var m = a(i + "> .w2ui-panel-content.new-panel");
                        l.css("top", k), m.css("top", k), "object" == typeof c ? (c.box = m[0], c.render()) : m.html(c), w2utils.transition(l[0], m[0], d, function() {
                            l.remove(), m.removeClass("new-panel"), m.css("overflow", f.overflow), e.resize(), window.navigator.userAgent.indexOf("MSIE") != -1 && setTimeout(function() {
                                e.resize()
                            }, 100)
                        })
                    }
            ...
            resize: function() {
                ...
                if (e.isCancelled !== !0) {
                    ...
                    for (var h, i, j, k, l, m = this, n = this.get("main"), o = this.get("preview"), p = this.get("left"), q = this.get("right"), r = this.get("top"), s = this.get("bottom"), t = null != o && o.hidden !== !0, u = null != p && p.hidden !== !0, v = null != q && q.hidden !== !0, w = null != r && r.hidden !== !0, x = null != s && s.hidden !== !0, y = 0; y < c.length; y++)
                        ...
                        "-" == String(q.size).substr(0, 1) && (u && "-" == String(p.size).substr(0, 1) ? console.log("ERROR: you cannot have both left panel.size and right panel.size be negative.") : q.sizeCalculated = f - (u ? p.sizeCalculated : 0) + parseInt(q.size)), "-" == String(p.size).substr(0, 1) && (v && "-" == q.size.substr(0, 1) ? console.log("ERROR: you cannot have both left panel.size and right panel.size be negative.") : p.sizeCalculated = f - (v ? q.sizeCalculated : 0) + parseInt(p.size)), null != r && r.hidden !== !0 ? (h = 0, i = 0, j = f, k = r.sizeCalculated, a("#layout_" + this.name + "_panel_top").css({
                        display: "block",
                        left: h + "px",
                        top: i + "px",
                        width: j + "px",
                    ...
                    }))) : (a("#layout_" + this.name + "_panel_top").hide(), a("#layout_" + this.name + "_resizer_top").hide()), null != p && p.hidden !== !0 ? (h = 0, i = 0 + (w ? r.sizeCalculated + this.padding : 0),
                        j = p.sizeCalculated, k = g - (w ? r.sizeCalculated + this.padding : 0) - (x ? s.sizeCalculated + this.padding : 0), l = a("#layout_" + this.name + "_panel_left"), window.navigator.userAgent.indexOf("MSIE") != -1 && l.length > 0 && l[0].clientHeight < l[0].scrollHeight && (j += 17), l.css({
                            display: "block",
                            left: h + "px",
                            top: i + "px",
                            width: j + "px",
...
! function(a) {
    a.fn.w2popup = function(b, c) {
        ...
        open: function(b) {
            ...
            function d(b) {
                if (1 == p.resizing) {
                    b || (b = window.event), p.div_x = b.screenX - p.x, p.div_y = b.screenY - p.y;
                    ...
                    c.isCancelled !== !0 && (a("#w2ui-popup").css(w2utils.cssPrefix({
                        transition: "none",
                        transform: "translate3d(" + p.div_x + "px, " + p.div_y + "px, 0px)"
                    })), w2popup.trigger(a.extend(c, {
                        phase: "after"
                    })))
                }
            }
            ...
            }, 100), 0 === a("#w2ui-popup").length && (w2popup.onMax = null, w2popup.onMin = null, w2popup.onToggle = null, w2popup.onOpen = null, w2popup.onClose = null, w2popup.onKeydown = null, w2popup.onAction = null), b.onOpen && (w2popup.onOpen = b.onOpen), b.onClose && (w2popup.onClose = b.onClose), b.onMax && (w2popup.onMax = b.onMax), b.onMin && (w2popup.onMin = b.onMin), b.onToggle && (w2popup.onToggle = b.onToggle), b.onKeydown && (w2popup.onKeydown = b.onKeydown), b.onAction && (w2popup.onAction = b.onAction), b.width = parseInt(b.width), b.height = parseInt(b.height);
            var h, i;
            ...
            var j = (i - b.height) / 2 * .6,
                k = (h - b.width) / 2;
            if (null != b.actions && (b.buttons = "", Object.keys(b.actions).forEach(function(a) {
                    var c = b.actions[a];
                    "function" == typeof c && (b.buttons += '<button class="w2ui-btn" onclick="w2popup.action(\'' + a + "')\">" + a + "</button>"), "object" == typeof c && (b.buttons += '<button class="w2ui-btn ' + (c.class || "") + '" style="' + (c.style || "") + '"onclick="w2popup.action(\'' + a + "')\">" + (c.text || a) + "</button>"), "string" == typeof c && (b.buttons += c)
                })), 0 === a("#w2ui-popup").length) {
                var l = this.trigger({
                    phase: "before",
                    type: "open",
                    target: "popup",
        ...
        action: function(b) {
            ...
            switch (typeof d) {
                case "function":
                    ...
                    break;
                case "object":
                    "function" == typeof d.onClick && d.onClick(b)
            }
        },
        keydown: function(b) {
            var c = a("#w2ui-popup").data("options");
        ...
        close: function(b) {
            ...
            if (0 !== a("#w2ui-popup").length && "closed" != this.status) {
                ...
                d.isCancelled !== !0 && (w2popup.status = "closing", a("#w2ui-popup").css("opacity", "0").css(w2utils.cssPrefix({
                    ...
                    c.restoreTemplate(), a("#w2ui-popup").remove(), w2popup.status = "closed", b._last_focus && b._last_focus.length > 0 && b._last_focus.focus(), c.trigger(a.extend(d, {
                        phase: "after"
                    }))
        ...
        message: function(b) {
            ...
            if ("" === a.trim(b.html) && "" === a.trim(b.body) && "" === a.trim(b.buttons)) {
                ...
                a("#w2ui-popup #w2ui-message" + i).css(w2utils.cssPrefix({
                    ...
                    a("#w2ui-popup #w2ui-message" + i).css(a.extend(w2utils.cssPrefix("transition", ".3s", !1), w2utils.cssPrefix({
        ...
        focus: function() {
            var b = null,
                c = a("#w2ui-popup"),
                d = "input:visible, button:visible, select:visible, textarea:visible, [contentEditable]";
...
var w2alert = function(a, b, c) {
    ...
    w2confirm = function(a, b, c) {
        ...
        return 1 == arguments.length && "object" == typeof a ? d.extend(e, f, a) : "function" == typeof b ? d.extend(e, f, {
            ...
            onOpen: function(a) {
                ...
                }), "function" == typeof e.onOpen && e.onOpen()
            },
            onClose: function(a) {
                ...
                }, 300), "function" == typeof e.onClose && e.onClose()
            }
            ...
            onOpen: function(a) {
                setTimeout(function() {
                    ...
                    }), e.focus_to_no ? d("#w2ui-popup .w2ui-popup-btn#No").focus() : d("#w2ui-popup .w2ui-popup-btn#Yes").focus(), "function" == typeof e.onOpen && e.onOpen()
                }, 1)
            },
            onClose: function(a) {
    ...
    w2prompt = function(a, b, c) {
        ...
        return 1 == arguments.length && "object" == typeof a ? d.extend(e, f, a) : "function" == typeof b ? d.extend(e, f, {
            ...
            buttons: w2utils.settings.macButtonOrder ? '<button id="Cancel" class="w2ui-popup-btn w2ui-btn ' + e.cancel_class + '">' + e.cancel_text + '</button><button id="Ok" class="w2ui-popup-btn w2ui-btn ' + e.ok_class + '">' + e.ok_text + "</button>" : '<button id="Ok" class="w2ui-popup-btn w2ui-btn ' + e.ok_class + '">' + e.ok_text + '</button><button id="Cancel" class="w2ui-popup-btn w2ui-btn ' + e.cancel_class + '">' + e.cancel_text + "</button>",
            onOpen: function() {
                d("#w2prompt").val(e.value), d("#w2ui-popup .w2ui-message .w2ui-btn#Ok").on("click.w2prompt", function(a) {
                    ...
                    d("#w2prompt").focus()
                }, 100), "function" == typeof e.onOpen && e.onOpen()
            },
            onClose: function() {
        ...
        refresh: function(b) {
            ...
            if (d.isCancelled !== !0) {
                if (null == b)
                    ...
                    var f = this.get(b);
                    if (null == f) return !1;
                    null == f.text && null != f.caption && (f.text = f.caption), null == f.tooltip && null != f.hint && (f.tooltip = f.hint), null != f.caption && console.log("NOTICE: tabs tab.caption property is deprecated, please use tab.text. Tab -> ", f), null != f.hint && console.log("NOTICE: tabs tab.hint property is deprecated, please use tab.tooltip. Tab -> ", f);
                    var g = f.text;
    ...
    a.fn.w2toolbar = function(c) {
        ...
        click: function(b, c) {
            var d = this,
                e = String(b).split(":"),
                f = this.get(e[0]),
                g = f && f.items ? w2obj.field.prototype.normMenu.call(this, f.items, f) : [];
            if (e.length > 1) {
                var h = this.get(b);
                return void(h && !h.disabled && d.menuClick({
                    name: d.name,
                    item: f,
                    subItem: h,
                    originalEvent: c
            ...
            if (f && !f.disabled) {
                ...
                if (i.isCancelled === !0) return;
                var j = "#tb_" + this.name + "_item_" + w2utils.escapeId(f.id) + " table.w2ui-button";
                if (a(j).removeClass("down"), "radio" == f.type) {
                    for (var k = 0; k < this.items.length; k++) {
                        var l = this.items[k];
                        null != l && l.id != f.id && "radio" === l.type && l.group == f.group && l.checked && (l.checked = !1, this.refresh(l.id))
                    }
                    f.checked = !0, a(j).addClass("checked")
                }
                if (["menu", "menu-radio", "menu-check", "drop", "color", "text-color"].indexOf(f.type) != -1 && (d.tooltipHide(b), f.checked ? setTimeout(function() {
                        ...
                        function b(b) {
                            f.checked = !1, a(j).removeClass("checked")
                        }
                        ...
                        if (e > 19 && (e = 19), "drop" == f.type && c.w2overlay(f.html, a.extend({
                            ...
                            var h = "normal";
                            "menu-radio" == f.type && (h = "radio", g.forEach(function(a) {
                                f.selected == a.id ? a.checked = !0 : a.checked = !1
                            })), "menu-check" == f.type && (h = "check", g.forEach(function(b) {
                        ...
                        }["color", "text-color"].indexOf(f.type) != -1 && a(c).w2color(a.extend({
                            color: f.color,
                            onHide: function(a) {
                    ...
                    }, 1)), ["check", "menu", "menu-radio", "menu-check", "drop", "color", "text-color"].indexOf(f.type) != -1 && (f.checked = !f.checked, f.checked ? a(j).addClass("checked") : a(j).removeClass("checked")), f.route) {
                    var m = String("/" + f.route).replace(/\/{2,}/g, "/"),
                        n = w2utils.parseRoute(m);
                    if (n.keys.length > 0)
                        for (var o = 0; o < n.keys.length; o++) m = m.replace(new RegExp(":" + n.keys[o].name, "g"), this.routeData[n.keys[o].name]);
                    setTimeout(function() {
                        window.location.hash = m
                    }, 1)
                }
                c && ["button", "check", "radio"].indexOf(f.type) != -1 && this.tooltipShow(b, c, !0), this.trigger(a.extend(i, {
                    phase: "after"
                }))
            }
        },
        ...
        render: function(b) {
            ...
            if (d.isCancelled !== !0 && (null != b && (a(this.box).find("> table #tb_" + this.name + "_right").length > 0 && a(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-toolbar").html(""), this.box = b), this.box)) {
                for (var e = '<div class="w2ui-scroll-wrapper" onmousedown="var el=w2ui[\'' + this.name + '\']; if (el) el.resize();"><table cellspacing="0" cellpadding="0" width="100%"><tbody><tr>', f = 0; f < this.items.length; f++) {
                    var g = this.items[f];
                    null != g && (null == g.id && (g.id = "item_" + f), null != g.caption && console.log("NOTICE: toolbar item.caption property is deprecated, please use item.text. Item -> ", g), null != g.hint && console.log("NOTICE: toolbar item.hint property is deprecated, please use item.tooltip. Item -> ", g), e += "spacer" == g.type ? '<td width="100%" id="tb_' + this.name + "_item_" + g.id + '" align="right"></td>' : '<td id="tb_' + this.name + "_item_" + g.id + '" style="' + (g.hidden ? "display: none" : "") + '"     class="' + (g.disabled ? "disabled" : "") + '" valign="middle"></td>')
                }
        ...
        getItemHTML: function(a) {
            ...
            var c = "<td>&#160;</td>",
                d = "function" == typeof a.text ? a.text.call(this, a) : a.text;
            if (a.img && (c = '<td><div class="w2ui-tb-image w2ui-icon ' + a.img + '"></div></td>'), a.icon && (c = '<td><div class="w2ui-tb-image"><span class="' + ("function" == typeof a.icon ? a.icon.call(this, a) : a.icon) + '"></span></div></td>'), "" === b) switch (a.type) {
                case "color":
                case "text-color":
        ...
        menuClick: function(b) {
            ...
            if (b.item && !b.item.disabled) {
                ...
                if ("menu-radio" == f.type && (f.selected = e.id, Array.isArray(b.item.items) && b.item.items.forEach(function(a) {
                        a.checked = !1
    ...
    a.fn.w2sidebar = function(c) {
        ...
        insert: function(c, d, e) {
            ...
            if (2 == arguments.length)
                if (e = arguments[1], d = arguments[0], null != d) {
                    if (g = this.get(d), null == g) return a.isArray(e) || (e = [e]), null != e[0].caption && null == e[0].text && (console.log("NOTICE: sidebar node.caption property is deprecated, please use node.text. Node -> ", e[0]), e[0].text = e[0].caption), f = e[0].text, console.log('ERROR: Cannot insert node "' + f + '" because cannot find node "' + d + '" to insert before.'), null;
                    c = this.get(d).parent
                } else c = this;
                ...
                if (i = e[k], null != typeof i.id)
                    if (null == this.get(this, i.id)) {
                        if (h = a.extend({}, b.prototype.node, i), h.sidebar = this, h.parent = c, j = h.nodes || [], h.nodes = [], null == d) c.nodes.push(h);
                            ...
                            if (g = this.get(c, d, !0), null == g) return console.log('ERROR: Cannot insert node "' + i.text + '" because cannot find node "' + d + '" to insert before.'), null;
                            c.nodes.splice(g, 0, h)
                        }
                        j.length > 0 && this.insert(h, null, j)
                    } else console.log("ERROR: Cannot insert node with id=" + i.id + " (text: " + i.text + ") because another node with the same id already exists.");
            else null != i.caption && null == i.text && (console.log("NOTICE: sidebar node.caption property is deprecated, please use node.text"), i.text = i.caption), f = i.text, console.log('ERROR: Cannot insert node "' + f + '" because it has no id.');
        ...
        refresh: function(b) {
            function c(a) {
                ...
                if (null != a.caption && null == a.text && (a.text = a.caption), null != a.caption && (console.log("NOTICE: sidebar node.caption property is deprecated, please use node.text. Node -> ", a), a.text = a.caption), a.group) b = '<div class="w2ui-node-group w2ui-level-' + f + (a.class ? " " + a.class : "") + '" id="node_' + a.id + '"   style="' + (a.hidden ? "display: none" : "") + '" onclick="w2ui[\'' + k.name + "'].toggle('" + a.id + "')\"   oncontextmenu=\"w2ui['" + k.name + "'].contextMenu('" + a.id + "', event);\"   onmouseout=\"jQuery(this).find('span:nth-child(1)').css('color', 'transparent')\"    onmouseover=\"jQuery(this).find('span:nth-child(1)').css('color', 'inherit')\">" + (a.groupShowHide && a.collapsible ? "<span>" + (!a.hidden && a.expanded ? w2utils.lang("Hide") : w2utils.lang("Show")) + "</span>" : "<span></span>") + ("function" == typeof a.text ? a.text.call(k, a) : "<span>" + a.text + "</span>") + '</div><div class="w2ui-node-sub" id="node_' + a.id + '_sub" style="' + a.style + ";" + (!a.hidden && a.expanded ? "" : "display: none;") + '"></div>', k.flat && (b = '<div class="w2ui-node-group" id="node_' + a.id + '"><span>&#160;</span></div><div id="node_' + a.id + '_sub" style="' + a.style + ";" + (!a.hidden && a.expanded ? "" : "display: none;") + '"></div>');
                else {
                    a.selected && !a.disabled && (k.selected = a.id), e = "", c && (e = '<div class="w2ui-node-image w2ui-icon ' + c + (a.selected && !a.disabled ? " w2ui-icon-selected" : "") + '"></div>'), d && (e = '<div class="w2ui-node-image"><span class="' + ("function" == typeof d ? d.call(k, a) : d) + '"></span></div>');
                    var g = a.text;
                    "function" == typeof a.text && (g = a.text.call(k, a)), b = '<div class="w2ui-node w2ui-level-' + f + (a.selected ? " w2ui-selected" : "") + (a.disabled ? " w2ui-disabled" : "") + (a.class ? " " + a.class : "") + '" id="node_' + a.id + '" style="' + (a.hidden ? "display: none;" : "") + '"    ondblclick="w2ui[\'' + k.name + "'].dblClick('" + a.id + "', event);\"    oncontextmenu=\"w2ui['" + k.name + "'].contextMenu('" + a.id + "', event);\"    onClick=\"w2ui['" + k.name + "'].click('" + a.id + '\', event); "><table cellpadding="0" cellspacing="0" style="margin-left:' + 18 * f + "px; padding-right:" + 18 * f + 'px"><tbody><tr><td class="w2ui-node-dots" nowrap="nowrap" onclick="w2ui[\'' + k.name + "'].toggle('" + a.id + '\');         if (event.stopPropagation) event.stopPropagation(); else event.cancelBubble = true;">    <div class="w2ui-expand">' + (a.nodes.length > 0 ? a.expanded ? "-" : "+" : a.plus ? "+" : "") + '</div></td><td class="w2ui-node-data" nowrap="nowrap">' + e + (a.count || 0 === a.count ? '<div class="w2ui-node-count">' + a.count + "</div>" : "") + '<div class="w2ui-node-text w2ui-node-caption">' + g + '</div></td></tr></tbody></table></div><div class="w2ui-node-sub" id="node_' + a.id + '_sub" style="' + a.style + ";" + (!a.hidden && a.expanded ? "" : "display: none;") + '"></div>', k.flat && (b = '<div class="w2ui-node w2ui-level-' + f + " " + (a.selected ? "w2ui-selected" : "") + " " + (a.disabled ? "w2ui-disabled" : "") + (a.class ? " " + a.class : "") + '" id="node_' + a.id + '" style="' + (a.hidden ? "display: none;" : "") + "\"    onmouseover=\"jQuery(this).find('.w2ui-node-data').w2tag(w2utils.base64decode('" + w2utils.base64encode(g + (a.count || 0 === a.count ? ' - <span class="w2ui-node-count">' + a.count + "</span>" : "")) + "'),                { id: '" + a.id + "', left: -5 })\"    onmouseout=\"jQuery(this).find('.w2ui-node-data').w2tag(null, { id: '" + a.id + "' })\"    ondblclick=\"w2ui['" + k.name + "'].dblClick('" + a.id + "', event);\"    oncontextmenu=\"w2ui['" + k.name + "'].contextMenu('" + a.id + "', event);\"    onClick=\"w2ui['" + k.name + "'].click('" + a.id + '\', event); "><div class="w2ui-node-data w2ui-node-flat">' + e + '</div></div><div class="w2ui-node-sub" id="node_' + a.id + '_sub" style="' + a.style + ";" + (!a.hidden && a.expanded ? "" : "display: none;") + '"></div>')
                }
                return b
            }
            var d = (new Date).getTime(),
    ...
    a.fn.w2field = function(c, d) {
            ...
            switch (this.type) {
                ...
                case "combo":
                    if (b = {
                            ...
                            openOnFocus: !1,
                            markSearch: !1
                        }, "function" == typeof d.items && (d._items_fun = d.items), d.items = w2obj.field.prototype.normMenu.call(this, d.items), "list" === this.type) {
                        if (b.openOnFocus = !0, a(this.el).addClass("w2ui-select"), !a.isPlainObject(d.selected) && Array.isArray(d.items))
                ...
                case "enum":
                    b = {
                        ...
                        suffix: ""
                    }), "function" == typeof d.items && (d._items_fun = d.items), d.items = w2obj.field.prototype.normMenu.call(this, d.items), d.selected = w2obj.field.prototype.normMenu.call(this, d.selected), this.options = d, a.isArray(d.selected) || (d.selected = []), a(this.el).data("selected", d.selected), d.url && (d.items = [], this.request(0)), this.addSuffix(), this.addMulti(), this.watchSize();
                    break;
                case "file":
                    b = {
                        selected: [],
        ...
        focus: function(b) {
            ...
            if (["list", "combo", "enum"].indexOf(c.type) !== -1) {
                ...
                }, 1), "function" == typeof c.options._items_fun && (c.options.items = w2obj.field.prototype.normMenu.call(this, c.options._items_fun))
            }
        ...
        request: function(b) {
            ...
            if (d.url) {
                ...
                null == b && (b = d.interval), null == c.tmp.xhr_search && (c.tmp.xhr_search = ""), null == c.tmp.xhr_total && (c.tmp.xhr_total = -1), d.url && (0 === d.items.length && 0 !== c.tmp.xhr_total || c.tmp.xhr_total == d.cacheMax && e.length > c.tmp.xhr_search.length || e.length >= c.tmp.xhr_search.length && e.substr(0, c.tmp.xhr_search.length) !== c.tmp.xhr_search || e.length < c.tmp.xhr_search.length) && (c.tmp.xhr && c.tmp.xhr.abort(), c.tmp.xhr_loading = !0, c.search(), clearTimeout(c.tmp.timeout), c.tmp.timeout = setTimeout(function() {
                    var b = d.url,
                        f = {
                            search: e,
                            max: d.cacheMax
                    ...
                    if (g.isCancelled !== !0) {
                        ...
                        d.method && (h.type = d.method), "JSON" === w2utils.settings.dataType && (h.type = "POST", h.data = JSON.stringify(h.data), h.contentType = "application/json"), "HTTPJSON" === w2utils.settings.dataType && (h.data = {
                            ...
                            if (i.isCancelled !== !0) {
                                ...
                                }), c.tmp.xhr_loading = !1, c.tmp.xhr_search = e, c.tmp.xhr_total = b.records.length, c.tmp.lastError = "", d.items = c.normMenu(b.records), "" === e && 0 === b.records.length ? c.tmp.emptySet = !0 : c.tmp.emptySet = !1;
                                var j = a(c.el).data("find_selected");
                                if (j) {
                                    var k;
                                    Array.isArray(j) ? (k = [], j.forEach(function(b) {
                                        d.items.forEach(function(c) {
                                            c.id == b && k.push(a.extend(!0, {}, c))
                                        })
                                    })) : d.items.forEach(function(a) {
                                        a.id == j && (k = a)
                                    }), a(c.el).data("selected", k).removeData("find_selected").change()
                                }
                                c.search(), c.trigger(a.extend(i, {
                                    phase: "after"
                                }))
                            }
                        }).fail(function(b, f, g) {
                            ...
                            if (i.isCancelled !== !0) {
                                ...
                                c.tmp.xhr_loading = !1, c.tmp.xhr_search = e, c.tmp.xhr_total = 0, c.tmp.emptySet = !0, c.tmp.lastError = i.error || "Server communication failed", d.items = [], c.clearCache(), c.search(), c.updateOverlay(!1), c.trigger(a.extend(i, {
                                    phase: "after"
                                }))
                            }
        ...
        search: function() {
            ...
            if (b.tmp.xhr_loading !== !0) {
                for (var j = 0, k = 0; k < i.length; k++) {
                    var l = i[k];
                    if (null != c.compare) "function" == typeof c.compare && (l.hidden = c.compare.call(this, l, d) === !1);
                    else {
                        var m = "",
                            n = "";
                        ["is", "begins"].indexOf(c.match) !== -1 && (m = "^"), ["is", "ends"].indexOf(c.match) !== -1 && (n = "$");
                        try {
                            var o = new RegExp(m + d + n, "i");
                            o.test(l.text) || "..." === l.text ? l.hidden = !1 : l.hidden = !0
                        } catch (a) {}
                    }
                    c.filter === !1 && (l.hidden = !1), "enum" === b.type && a.inArray(l.id, f) !== -1 && (l.hidden = !0), l.hidden !== !0 && (j++, delete l.hidden)
                }
                for (c.index = -1; i[c.index] && i[c.index].hidden;) c.index++;
                j <= 0 && (c.index = -1), c.spinner = !1, b.updateOverlay(), setTimeout(function() {
                    var b = a("#w2ui-overlay").html() || "";
                    c.markSearch && b.indexOf("$.fn.w2menuHandler") !== -1 && a("#w2ui-overlay").w2marker(d)
                }, 1)
            } else i.splice(0, c.cacheMax), c.spinner = !0, b.updateOverlay()
        },
        updateOverlay: function(b) {
            ...
            if ("color" === this.type) {
                ...
                a(this.el).w2color({
                    ...
                    null != b && a(c.el).val(b).trigger("input").change()
                })
            }
            if ("date" === this.type) {
                if (a(c.el).prop("readonly") || a(c.el).prop("disabled")) return;
                ...
                g && (e = g.getMonth() + 1, f = g.getFullYear()),
                    function b(d, e) {
                        a("#w2ui-overlay > div > div").html(c.getMonthHTML(d, e, a(c.el).val())), a("#w2ui-overlay .w2ui-calendar-title").on("mousedown", function() {
                            ...
                            a(c.el).val(b).trigger("input").change(), a(this).css({
            ...
            if ("time" === this.type) {
                ...
                a("#w2ui-overlay > div").html(c.getHourHTML()), a("#w2ui-overlay .w2ui-time").on("mousedown", function(b) {
                    ...
                    a(c.el).val((d > 12 && !h ? d - 12 : d) + ":00" + (h ? "" : d < 12 ? " am" : " pm")).trigger("input").change()
                    ...
                    a("#w2ui-overlay").length > 0 && a("#w2ui-overlay")[0].hide(), a(c.el).w2overlay('<div class="w2ui-reset w2ui-calendar-time"></div>', {
                        ...
                        a(c.el).val((b > 12 && !h ? b - 12 : b) + ":" + (d < 10 ? 0 : "") + d + (h ? "" : b < 12 ? " am" : " pm")).trigger("input").change()
                    }).on("mouseup", function() {
                        setTimeout(function() {
                            a("#w2ui-overlay").length > 0 && a("#w2ui-overlay").removeData("keepOpen")[0].hide()
                        }, 10)
                ...
                ! function b(e, f) {
                    a("#w2ui-overlay > div > div").html(c.getMonthHTML(e, f, a(c.el).val()) + (d.btn_now ? '<div class="w2ui-calendar-now now">' + w2utils.lang("Current Date & Time") + "</div>" : "")), a("#w2ui-overlay .w2ui-calendar-title").on("mousedown", function() {
                        ...
                        a("#w2ui-overlay > div").html(c.getHourHTML()), a("#w2ui-overlay .w2ui-time").on("mousedown", function(d) {
                            ...
                            a(c.el).val(e).trigger("input").change()
                        ...
                        return a(c.el).val(b).trigger("input").change(), !1
                    }).on("mouseup", function() {
                        setTimeout(function() {
                            a("#w2ui-overlay").length > 0 && a("#w2ui-overlay").removeData("keepOpen")[0].hide()
                        }, 10)
                        ...
                        onSelect: function(b) {
                            if ("enum" === c.type) {
                                ...
                                if (b.item) {
                                    ...
                                    if (f.isCancelled === !0) return;
                                    e.length >= d.max && d.max > 0 && e.pop(), delete b.item.hidden, e.push(b.item), a(c.el).data("selected", e).trigger("input").change(), a(c.helpers.multi).find("input").val("").width(20), c.refresh(), a("#w2ui-overlay").length > 0 && a("#w2ui-overlay")[0].hide(), c.trigger(a.extend(f, {
                                        phase: "after"
                                    }))
                                }
                            } else a(c.el).data("selected", b.item).val(b.item.text).trigger("input").change(), c.helpers.focus && c.helpers.focus.find("input").val("")
                        }
                    });
                    a(j).w2menu(b ? "refresh-index" : "refresh", n)
                }
            }
        },
        ...
        normMenu: function(b, c) {
            if (a.isArray(b)) {
                for (var d = 0; d < b.length; d++) "string" == typeof b[d] ? b[d] = {
                    id: b[d],
                    text: b[d]
                } : null != b[d] ? (null != b[d].text && null == b[d].id && (b[d].id = b[d].text), null == b[d].text && null != b[d].id && (b[d].text = b[d].id), null != b[d].caption && (b[d].text = b[d].caption)) : b[d] = {
                    id: null,
                    text: "null"
                };
                return b
            }
            if ("function" == typeof b) return w2obj.field.prototype.normMenu.call(this, b.call(this, c));
            if ("object" == typeof b) {
                var e = [];
                for (var d in b) e.push({
                    id: d,
                    text: b[d]
                });
                return e
    ...
    $.fn.w2form = function(a) {
        if ($.isPlainObject(a)) {
            ...
            if ($.extend(!0, h.toolbar, f), e)
                for (var k = 0; k < e.length; k++) {
                    var l = $.extend(!0, {}, e[k]);
                    null == l.field && null != l.name && (console.log("NOTICE: form field.name property is deprecated, please use field.field. Field ->", l), l.field = l.name), h.fields[k] = l
                }
            ...
            }) : "" !== h.formHTML || (0 !== $(this).length && "" !== $.trim($(this).html()) ? h.formHTML = $(this).html() : h.formHTML = h.generateHTML()), w2ui[h.name] = h, "" === h.formURL && (String(h.formHTML).indexOf("w2ui-page") === -1 && (h.formHTML = '<div class="w2ui-page page-0" style="' + (h.pageStyle || "") + '">' + h.formHTML + "</div>"), $(h.box).html(h.formHTML), h.isGenerated = !0, h.render(h.box)), h
        }
        ...
        get: function(a, b) {
            if (0 === arguments.length) {
                for (var c = [], d = 0; d < this.fields.length; d++) null != this.fields[d].field && c.push(this.fields[d].field);
                return c
            }
            for (var e = 0; e < this.fields.length; e++)
                if (this.fields[e].field == a) return b === !0 ? e : this.fields[e];
            return null
        },
        set: function(a, b) {
            for (var c = 0; c < this.fields.length; c++)
                if (this.fields[c].field == a) return $.extend(this.fields[c], b), this.refresh(a), !0;
            return !1
        },
        getValue: function(a) {
            if (this.nestedFields) {
                ...
                try {
                    var c = this.record;
                    b = String(a).split(".").reduce(function(a, b) {
                        return a[b]
                    }, c)
                } catch (a) {}
                return b
            }
            return this.record[a]
        },
        setValue: function(a, b) {
            if (!this.nestedFields) return this.record[a] = b, !0;
            try {
                var c = this.record;
                return String(a).split(".").map(function(a, d, e) {
                    e.length - 1 !== d ? c[a] ? c = c[a] : (c[a] = {}, c = c[a]) : c[a] = b
                }), !0
            } catch (a) {
                return !1
            }
        ...
        show: function() {
            for (var a = [], b = 0; b < arguments.length; b++) {
                var c = this.get(arguments[b]);
                c && c.hidden && (c.hidden = !1, a.push(c.field))
            }
            return a.length > 0 && this.refresh.apply(this, a), a.length
        },
        hide: function() {
            for (var a = [], b = 0; b < arguments.length; b++) {
                var c = this.get(arguments[b]);
                c && !c.hidden && (c.hidden = !0, a.push(c.field))
            }
            return a.length > 0 && this.refresh.apply(this, a), a.length
        },
        enable: function() {
            for (var a = [], b = 0; b < arguments.length; b++) {
                var c = this.get(arguments[b]);
                c && c.disabled && (c.disabled = !1, a.push(c.field))
            }
            return a.length > 0 && this.refresh.apply(this, a), a.length
        },
        disable: function() {
            for (var a = [], b = 0; b < arguments.length; b++) {
                var c = this.get(arguments[b]);
                c && !c.disabled && (c.disabled = !0, a.push(c.field))
            }
            return a.length > 0 && this.refresh.apply(this, a), a.length
        },
        change: function() {
        ...
        clear: function() {
            0 != arguments.length ? Array.from(arguments).forEach(function(a) {
                var b = this.record;
                String(a).split(".").map(function(a, c, d) {
                    d.length - 1 !== c ? b = b[a] : delete b[a]
                }), this.refresh(a)
            }.bind(this)) : (this.recid = 0, this.record = {}, this.original = null, this.refresh()), $().w2tag()
        },
        error: function(a) {
            var b = this,
                c = this.trigger({
        ...
        validate: function(a) {
            ...
            for (var b = [], c = 0; c < this.fields.length; c++) {
                var d = this.fields[c];
                switch (null == this.getValue(d.field) && this.setValue(d.field, ""), d.type) {
                    case "int":
                        this.getValue(d.field) && !w2utils.isInt(this.getValue(d.field)) && b.push({
                            field: d,
                            error: w2utils.lang("Not an integer")
                        });
                        break;
                    case "float":
                        this.getValue(d.field) && !w2utils.isFloat(this.getValue(d.field)) && b.push({
                            field: d,
                            error: w2utils.lang("Not a float")
                        });
                        break;
                    case "money":
                        this.getValue(d.field) && !w2utils.isMoney(this.getValue(d.field)) && b.push({
                            field: d,
                    ...
                    case "color":
                    case "hex":
                        this.getValue(d.field) && !w2utils.isHex(this.getValue(d.field)) && b.push({
                            field: d,
                            error: w2utils.lang("Not a hex number")
                        });
                        break;
                    case "email":
                        this.getValue(d.field) && !w2utils.isEmail(this.getValue(d.field)) && b.push({
                            field: d,
                            error: w2utils.lang("Not a valid email")
                        });
                        break;
                    case "checkbox":
                        1 == this.getValue(d.field) ? this.setValue(d.field, 1) : this.setValue(d.field, 0);
                        break;
                    case "date":
                        d.options.format || (d.options.format = w2utils.settings.dateFormat), this.getValue(d.field) && !w2utils.isDate(this.getValue(d.field), d.options.format) && b.push({
                            field: d,
                ...
                var e = this.getValue(d.field);
                d.required && d.hidden !== !0 && ("" === e || $.isArray(e) && 0 === e.length || $.isPlainObject(e) && $.isEmptyObject(e)) && b.push({
                    field: d,
                    error: w2utils.lang("Required field")
                }), d.options && d.hidden !== !0 && d.options.minLength > 0 && ["enum", "list", "combo"].indexOf(d.type) == -1 && this.getValue(d.field).length < d.options.minLength && b.push({
                    field: d,
                    error: w2utils.lang("Field should be at least " + d.options.minLength + " characters.")
                })
            }
            var f = this.trigger({
                phase: "before",
            ...
            if (f.isCancelled !== !0) {
                if (a)
                    for (var g = 0; g < f.errors.length; g++) {
                        ...
                        null != h.field && ("radio" === h.field.type ? $($(h.field.el).closest("div")[0]).w2tag(h.error, i) : ["enum", "file"].indexOf(h.field.type) !== -1 ? ! function(a) {
                            setTimeout(function() {
        ...
        getChanges: function() {
            ...
            var b = {};
            return null == this.original || "object" != typeof this.original || $.isEmptyObject(this.record) || (b = a(this.record, this.original, {})), b
        },
        getCleanRecord: function(a) {
            var b = $.extend(!0, {}, this.record);
            return this.fields.forEach(function(a) {
                if (["list", "combo", "enum"].indexOf(a.type) != -1) {
                    var c = {
                            nestedFields: !0,
                            record: b
                        },
                        d = this.getValue.call(c, a.field);
                    $.isPlainObject(d) && d.id && this.setValue.call(c, a.field, d.id), Array.isArray(d) && d.forEach(function(a, b) {
                        $.isPlainObject(a) && a.id && (d[b] = a.id)
                    })
                }
                if ("map" == a.type) {
                    var c = {
                        ...
                        d = this.getValue.call(c, a.field);
                    d._order && delete d._order
                }
            }.bind(this)), a === !0 && Object.keys(b).forEach(function(a) {
                this.get(a) || delete b[a]
            }.bind(this)), b
        },
            ...
            if ("function" == typeof postData && (callBack = postData, postData = null), null == postData && (postData = {}), this.url && ("object" != typeof this.url || this.url.get)) {
                ...
                this.method && (ajaxOptions.type = this.method), edata.method && (ajaxOptions.type = edata.method), this.last.xhr = $.ajax(ajaxOptions).done(function(data, status, xhr) {
                    ...
                    return edata.isCancelled === !0 ? void("function" == typeof callBack && callBack({
                        ...
                        phase: "after"
                    })), obj.refresh(), obj.applyFocus(), void("function" == typeof callBack && callBack(edata.data)))
                }).fail(function(a, b, c) {
                    var d = {
                            status: b,
                            error: c,
                    ...
                    if (e.isCancelled !== !0) {
                        if ("abort" !== b) {
                            ...
                            console.log("ERROR: Server communication failed.", "\n   EXPECTED:", {
                                ...
                                status: "error",
                                message: "error message"
                            }, "\n   RECEIVED:", "object" == typeof f ? f : a.responseText), obj.unlock()
                        }
            ...
            if (0 === errors.length) {
                ...
                obj.lock(w2utils.lang(obj.msgSaving) + ' <span id="' + obj.name + '_progress"></span>'), setTimeout(function() {
                    ...
                    params.cmd = "save", params.recid = obj.recid, params.name = obj.name, $.extend(params, obj.postData), $.extend(params, postData), obj.multipart || obj.fields.forEach(function(a) {
                        "file" === a.type && Array.isArray(obj.getValue(a.field)) && obj.getValue(a.field).forEach(function(a) {
                            delete a.file
                        })
                    ...
                    if (edata.isCancelled !== !0) {
                        ...
                        this.method && (ajaxOptions.type = this.method), edata.method && (ajaxOptions.type = edata.method), obj.last.xhr = $.ajax(ajaxOptions).done(function(data, status, xhr) {
                                ...
                                if ("error" !== status) {
                                    if (null != responseText && "" !== responseText) {
                                        ...
                                        null == data && (data = {
                                            ...
                                            message: w2utils.lang(obj.msgNotJSON),
                                            responseText: responseText
                                        }), "error" === data.status ? obj.error(w2utils.lang(data.message)) : obj.original = null
                                    }
                            ...
                            e.isCancelled !== !0 && (console.log("ERROR: server communication failed. The server should return", {
                                ...
                                status: "error",
                                message: "error message"
                            }, ", instead the AJAX request produced this: ", d), obj.unlock(), obj.trigger($.extend(e, {
                                phase: "after"
                            })))
                        }), obj.trigger($.extend(edata, {
                            phase: "after"
        ...
        generateHTML: function() {
            for (var a, b, c, d, e, f = [], g = "", h = 0; h < this.fields.length; h++) {
                ...
                var i = this.fields[h];
                null == i.html && (i.html = {}), null == i.options && (i.options = {}), null != i.html.caption && null == i.html.label && (console.log("NOTICE: form field.html.caption property is deprecated, please use field.html.label. Field ->", i), i.html.label = i.html.caption), null == i.html.label && (i.html.label = i.field), i.html = $.extend(!0, {
                    label: "",
                    span: 6,
                    attr: "",
                    text: "",
                    ...
                    page: 0,
                    column: 0
                }, i.html), null == a && (a = i.html.page), null == b && (b = i.html.column);
                var j = '<input id="' + i.field + '" name="' + i.field + '" class="w2ui-input" type="text" ' + i.html.attr + e + ">";
                switch (i.type) {
                    case "pass":
                    case "password":
                        j = '<input id="' + i.field + '" name="' + i.field + '" class="w2ui-input" type = "password" ' + i.html.attr + e + ">";
                        break;
                    case "checkbox":
                        j = '<label>   <input id="' + i.field + '" name="' + i.field + '" style="float: left" class="w2ui-input" type="checkbox" ' + i.html.attr + e + '>   <div style="margin: 6px 0 0 20px; user-select: none;">' + i.html.label + "</div></label>";
                        break;
                    case "radio":
                        j = "";
                        var k = i.options.items ? i.options.items : i.html.items;
                        $.isArray(k) || (k = []), k.length > 0 && (k = w2obj.field.prototype.normMenu.call(this, k, i));
                        for (var l = 0; l < k.length; l++) j += '<label style="user-select: none">  <input id="' + i.field + '" name="' + i.field + '" class="w2ui-input" type = "radio" ' + i.html.attr + (0 === l ? e : "") + ' value="' + k[l].id + '">&#160;' + k[l].text + "</label><br>";
                        break;
                    case "select":
                        j = '<select id="' + i.field + '" name="' + i.field + '" class="w2ui-input" ' + i.html.attr + e + ">";
                        var k = i.options.items ? i.options.items : i.html.items;
                        $.isArray(k) || (k = []), k.length > 0 && (k = w2obj.field.prototype.normMenu.call(this, k, i));
                        ...
                        break;
                    case "textarea":
                        j = '<textarea id="' + i.field + '" name="' + i.field + '" class="w2ui-input" ' + i.html.attr + e + "></textarea>";
                        break;
                    case "toggle":
                        j = '<input id="' + i.field + '" name="' + i.field + '" type="checkbox" ' + i.html.attr + e + ' class="w2ui-input w2ui-toggle"><div><div></div></div>';
                        break;
                    case "map":
                    case "array":
                        i.html.key = i.html.key || {}, i.html.value = i.html.value || {}, j = '<span style="float: right">' + (i.html.text || "") + '</span><input id="' + i.field + '" name="' + i.field + '" type="hidden" ' + i.html.attr + e + '><div class="w2ui-map-container"></div>';
                        break;
                    case "html":
                    case "custom":
                    case "empty":
                        j = i && i.html && i.html.html ? i.html.html : ""
                }
                if ("" !== g && (a != i.html.page || b != i.html.column || i.html.group && g != i.html.group) && (f[a][b] += "\n   </div>", g = ""), i.html.group && g != i.html.group) {
                    var m = "";
                    i.html.groupCollapsable && (m = '<span class="w2ui-icon-expand" style="width: 15px; display: inline-block; position: relative; top: -2px;"></span>'), c += '\n   <div class="w2ui-group-title" ' + ("" != m ? 'data-group="' + w2utils.base64encode(i.html.group) + '"' : "") + ("" != m ? 'style="cursor: pointer"' : "") + ("" != m ? "onclick=\"w2ui['" + this.name + "'].toggleGroup('" + i.html.group + "')\"" : "") + ">" + m + i.html.group + '</div>\n   <div class="w2ui-group" style="' + (i.html.groupStyle || "") + '">', g = i.html.group
                }
                if (null == i.html.anchor) {
                    var n = null != i.html.span ? "w2ui-span" + i.html.span : "";
                    i.html.span == -1 && (n = "w2ui-span-none"), c += '\n      <div class="w2ui-field ' + n + '" style="' + (i.hidden ? "display: none;" : "") + i.html.style + '">\n         <label' + ("none" == n ? ' style="display: none"' : "") + ">" + w2utils.lang("checkbox" != i.type ? i.html.label : i.html.text) + "</label>" + ("empty" === i.type ? "" : "\n         <div>" + j + ("array" != i.type && "map" != i.type ? w2utils.lang("checkbox" != i.type ? i.html.text : "") : "") + "</div>") + "\n      </div>"
                } else f[i.html.page].anchors = f[i.html.page].anchors || {}, f[i.html.page].anchors[i.html.anchor] = '<div class="w2ui-field w2ui-field-inline" style="' + (i.hidden ? "display: none;" : "") + i.html.style + '">' + ("empty" === i.type ? "" : "<div>" + w2utils.lang("checkbox" != i.type ? i.html.label : i.html.text) + j + w2utils.lang("checkbox" != i.type ? i.html.text : "") + "</div>") + "</div>";
                null == f[i.html.page] && (f[i.html.page] = {}), null == f[i.html.page][i.html.column] && (f[i.html.page][i.html.column] = ""), f[i.html.page][i.html.column] += c, a = i.html.page, b = i.html.column
            }
            if ("" !== g && (f[a][b] += "\n   </div>"), this.tabs.tabs)
            ...
            if (!$.isEmptyObject(this.actions)) {
                ...
                for (var p in this.actions) {
                    var q = this.actions[p],
                        r = {
                            text: "",
                            style: "",
                            class: ""
                        };
                    $.isPlainObject(q) ? (null == q.text && null != q.caption && (console.log("NOTICE: form action.caption property is deprecated, please use action.text. Action ->", q), q.text = q.caption), q.text && (r.text = q.text), q.style && (r.style = q.style), q.class && (r.class = q.class)) : (r.text = p, ["save", "update", "create"].indexOf(p.toLowerCase()) !== -1 ? r.class = "w2ui-btn-blue" : r.class = ""), o += '\n    <button name="' + p + '" class="w2ui-btn ' + r.class + '" style="' + r.style + '" tabindex="' + d + '">' + w2utils.lang(r.text) + "</button>", d++
                }
                o += "\n</div>"
            }
            c = "";
            for (var s = 0; s < f.length; s++) c += '<div class="w2ui-page page-' + s + '" style="' + (0 !== s ? "display: none;" : "") + this.pageStyle + '">', f[s].before && (c += f[s].before), c += '<div class="w2ui-column-container">', Object.keys(f[s]).sort().forEach(function(a, b) {
                a == parseInt(a) && (c += '<div class="w2ui-column col-' + a + '">' + (f[s][a] || "") + "\n</div>")
            }), c += "\n</div>", f[s].after && (c += f[s].after), c += "\n</div>", f[s].anchors && Object.keys(f[s].anchors).forEach(function(a, b) {
                c = c.replace(a, f[s].anchors[a])
            });
            return c += o
        },
        toggleGroup: function(a, b) {
            var c = $(this.box).find('.w2ui-group-title[data-group="' + w2utils.base64encode(a) + '"]');
            if ("none" == c.next().css("display") && b !== !0) c.next().slideDown(300), c.next().next().remove(), c.find("span").addClass("w2ui-icon-collapse").removeClass("w2ui-icon-expand");
            else {
                c.next().slideUp(300);
                var d = "width: " + c.next().css("width") + ";padding-left: " + c.next().css("padding-left") + ";padding-right: " + c.next().css("padding-right") + ";margin-left: " + c.next().css("margin-left") + ";margin-right: " + c.next().css("margin-right") + ";";
                setTimeout(function() {
                    c.next().after('<div style="height: 5px;' + d + '"></div>')
                }, 100), c.find("span").addClass("w2ui-icon-expand").removeClass("w2ui-icon-collapse")
            }
        },
        action: function(a, b) {
        ...
        refresh: function() {
            ...
            if (this.box && this.isGenerated && null != $(this.box).html()) {
                ...
                if (c.isCancelled !== !0) {
                    var d = Array.from(this.fields.keys());
                    arguments.length > 0 ? d = Array.from(arguments).map(function(a, b) {
                        return "string" != typeof a && console.log("ERROR: Arguments in refresh functions should be field names"), this.get(a, !0)
                    }.bind(this)).filter(function(a, b) {
                        return null != a
                    }) : ($(this.box).find("input, textarea, select").each(function(a, c) {
                        var d = null != $(c).attr("name") ? $(c).attr("name") : $(c).attr("id"),
                            e = b.get(d);
                        if (e) {
                            var f = $(c).closest(".w2ui-page");
                            if (f.length > 0)
                                for (var g = 0; g < 100; g++)
                    ...
                    for (var e = 0; e < d.length; e++) {
                        var f = this.fields[d[e]];
                        null == f.name && null != f.field && (f.name = f.field), null == f.field && null != f.name && (f.field = f.name), f.$el = $(this.box).find('[name="' + String(f.name).replace(/\\/g, "\\\\") + '"]'), f.el = f.$el[0], f.el && (f.el.id = f.name);
                        var g = $(f).data("w2field");
                        if (g && g.clear(), $(f.$el).off(".w2form").on("change.w2form", function(a) {
                                var c = this.value,
                                    d = null != b.getValue(this.name) ? b.getValue(this.name) : "",
                                    e = b.get(this.name);
                                if (["list", "enum", "file"].indexOf(e.type) !== -1 && $(this).data("selected")) {
                                    var f = $(this).data("selected"),
                                        g = b.getValue(this.name);
                                    if ($.isArray(f)) {
                                        c = [];
                                        for (var h = 0; h < f.length; h++) c[h] = $.extend(!0, {}, f[h])
                                    }
                                    if ($.isPlainObject(f) && (c = $.extend(!0, {}, f)), $.isArray(g)) {
                                        d = [];
                                        for (var h = 0; h < g.length; h++) d[h] = $.extend(!0, {}, g[h])
                                    }
                                    $.isPlainObject(g) && (d = $.extend(!0, {}, g))
                                }
                                if (["toggle", "checkbox"].indexOf(e.type) !== -1 && (c = !!$(this).prop("checked") && ("on" === $(this).prop("value") || $(this).prop("value"))), ["int", "float", "percent", "money", "currency"].indexOf(e.type) !== -1 && (c = $(this).data("w2field").clean(c)), c !== d) {
                                    var i = b.trigger({
                                        phase: "before",
                                        target: this.name,
                                        type: "change",
                                    ...
                                    if (i.isCancelled === !0) return void $(this).val(b.getValue(this.name));
                                    var j = this.value;
                                    if ("select" === this.type && (j = this.value), "checkbox" === this.type && (j = !!this.checked), "radio" === this.type && e.$el.each(function(a, b) {
                                            b.checked && (j = b.value)
                                        }), ["int", "float", "percent", "money", "currency", "list", "combo", "enum", "file", "toggle"].indexOf(e.type) !== -1 && (j = c), ["enum", "file"].indexOf(e.type) !== -1 && j.length > 0) {
                                        var k = $(e.el).data("w2field").helpers.multi;
                                        $(k).removeClass("w2ui-error")
                                    }("" === j || null == j || $.isArray(j) && 0 === j.length || $.isPlainObject(j) && $.isEmptyObject(j)) && (j = null), b.setValue(this.name, j), b.trigger($.extend(i, {
                                        phase: "after"
                                    }))
                                }
                            }).on("input.w2form", function(a) {
                                var c = this.value;
                                "checkbox" == a.target.type && (c = a.target.checked), null == b.original && ($.isEmptyObject(b.record) ? b.original = {} : b.original = $.extend(!0, {}, b.record));
                                var d = b.trigger({
                                    phase: "before",
                                    target: this.name,
                                    type: "input",
                                ...
                                d.isCancelled !== !0 && b.trigger($.extend(d, {
                                    phase: "after"
                                }))
                            }), f.required ? $(f.el).parent().parent().addClass("w2ui-required") : $(f.el).parent().parent().removeClass("w2ui-required"), null != f.disabled) {
                            var h = $(f.el);
                            f.disabled ? (null == h.data("w2ui-tabIndex") && h.data("w2ui-tabIndex", h.prop("tabIndex")), $(f.el).prop("readonly", !0).prop("tabindex", -1).closest(".w2ui-field").addClass("w2ui-disabled")) : $(f.el).prop("readonly", !1).prop("tabIndex", h.data("w2ui-tabIndex")).closest(".w2ui-field").removeClass("w2ui-disabled")
                        }
                        var g = f.el;
                        g || (g = $(this.box).find("#" + f.field)), f.hidden ? $(g).closest(".w2ui-field").hide() : $(g).closest(".w2ui-field").show()
                    }
                    ...
                    for (var e = 0; e < d.length; e++) {
                        var f = this.fields[d[e]],
                            i = null != this.getValue(f.name) ? this.getValue(f.name) : "";
                        if (f.el) switch ($(f.el).hasClass("w2ui-input") || $(f.el).addClass("w2ui-input"), f.type = String(f.type).toLowerCase(), f.options || (f.options = {}), f.type) {
                            case "text":
                            case "textarea":
                            case "email":
                            case "pass":
                            ...
                            case "currency":
                            case "percent":
                                f.el.value = i, $(f.el).w2field($.extend({}, f.options, {
                                    type: f.type
                                }));
                                break;
                            case "hex":
                            ...
                            case "time":
                                ...
                                break;
                            case "toggle":
                                w2utils.isFloat(i) && (i = parseFloat(i)), $(f.el).prop("checked", !!i), this.setValue(f.name, !!i && i);
                                break;
                            case "list":
                            case "combo":
                                if ("list" === f.type) {
                                    var j = $.isPlainObject(i) ? i.id : $.isPlainObject(f.options.selected) ? f.options.selected.id : i;
                                    f.options.items || (f.options.items = []);
                                    var k = f.options.items,
                                        l = !1;
                                    if (Array.isArray(f.options.items))
                                        for (var m = 0; m < f.options.items.length; m++) {
                                            var n = f.options.items[m];
                                            if (n.id == j) {
                                                i = $.extend(!0, {}, n), b.setValue(f.name, i), l = !0;
                                                break
                                            }
                                        }
                                    l || null == i || "" === i || f.$el.data("find_selected", i)
                                } else "combo" !== f.type || $.isPlainObject(i) ? $.isPlainObject(i) && null != i.text ? f.el.value = i.text : f.el.value = "" : f.el.value = i;
                                $.isPlainObject(i) || (i = {}), $(f.el).w2field($.extend({}, f.options, {
                                    type: f.type,
                                    selected: i
                                }));
                                break;
                            ...
                            case "file":
                                var o = [],
                                    l = !1;
                                $.isArray(i) || (i = []), "function" != typeof f.options.items && ($.isArray(f.options.items) || (f.options.items = []), i.forEach(function(a) {
                                    f.options.items.forEach(function(b) {
                                        b && (b.id == a || $.isPlainObject(a) && b.id == a.id) && (o.push($.isPlainObject(b) ? $.extend(!0, {}, b) : b), l = !0)
                                    })
                                })), l || null == i || 0 === i.length || (f.$el.data("find_selected", i), o = i);
                                var p = $.extend({}, f.options, {
                                    type: f.type,
                                    selected: o
                                });
                                Object.keys(f.options).forEach(function(a) {
                                    "function" == typeof f.options[a] && (p[a] = f.options[a])
                                }), $(f.el).w2field(p);
                                break;
                            case "select":
                                var k = f.options.items;
                                if (null != k && k.length > 0) {
                                    k = w2obj.field.prototype.normMenu.call(this, k, f), $(f.el).html("");
                                    for (var q = 0; q < k.length; q++) $(f.el).append('<option value="' + k[q].id + '">' + k[q].text + "</option")
                                }
                                $(f.el).val(i);
                                break;
                            case "map":
                            case "array":
                                "map" != f.type || null != i && $.isPlainObject(i) || (this.setValue(f.field, {}), i = this.getValue(f.field)), "array" != f.type || null != i && Array.isArray(i) || (this.setValue(f.field, []), i = this.getValue(f.field)),
                                    function(a, b) {
                                        b.el.mapAdd = function(a, b, c) {
                                            var d = a.disabled ? " readOnly " : "",
                                                e = '<div class="w2ui-map-field" style="margin-bottom: 5px"><input id="' + a.field + "_key_" + c + '" data-cnt="' + c + '" type="text" ' + a.html.key.attr + d + ' class="w2ui-input w2ui-map key">' + (a.html.key.text || "") + '<input id="' + a.field + "_value_" + c + '" data-cnt="' + c + '" type="text" ' + a.html.value.attr + d + ' class="w2ui-input w2ui-map value">' + (a.html.value.text || "") + "</div>";
                                            b.append(e)
                                        }, b.el.mapRefresh = function(c, d) {
                                            var e, f = 1;
                                            "map" == b.type && ($.isPlainObject(c) || (c = {}), null == c._order && (c._order = Object.keys(c)), e = c._order), "array" == b.type && (Array.isArray(c) || (c = []), e = c.map(function(a) {
                                                return a.key
                                            }));
                                            var g, h;
                                            e.forEach(function(a) {
                                                g = d.find("#" + w2utils.escapeId(b.name) + "_key_" + f), h = d.find("#" + w2utils.escapeId(b.name) + "_value_" + f), 0 != g.length && 0 != h.length || (b.el.mapAdd(b, d, f), g = d.find("#" + w2utils.escapeId(b.name) + "_key_" + f), h = d.find("#" + w2utils.escapeId(b.name) + "_value_" + f));
                                                var e = c[a];
                                                if ("array" == b.type) {
                                                    var i = c.filter(function(b) {
                                                        return b.key == a
                                                    });
                                                    i.length > 0 && (e = i[0].value)
                                                }
                                                g.val(a), h.val(e), b.disabled !== !0 && b.disabled !== !1 || (g.prop("readOnly", !!b.disabled), h.prop("readOnly", !!b.disabled)), g.parents(".w2ui-map-field").attr("data-key", a), f++
                                            });
                                            var i = d.find("#" + w2utils.escapeId(b.name) + "_key_" + f).parent(),
                                                j = d.find("#" + w2utils.escapeId(b.name) + "_key_" + (f + 1)).parent();
                                            0 !== i.length || g && (g.prop("readOnly") === !0 || g.prop("disabled") === !0) || b.el.mapAdd(b, d, f), 1 == i.length && 1 == j.length && (i.removeAttr("data-key"), i.find(".key").val(j.find(".key").val()), i.find(".value").val(j.find(".value").val()), j.remove()), b.disabled !== !0 && b.disabled !== !1 || (i.find(".key").prop("readOnly", !!b.disabled), i.find(".value").prop("readOnly", !!b.disabled)), $(b.el).next().find("input.w2ui-map").off(".mapChange").on("keyup.mapChange", function(a) {
                                                var b = $(a.target).parents(".w2ui-map-field");
                                                13 == a.keyCode && b.next().find("input.key").focus()
                                            }).on("change.mapChange", function() {
                                                var e = $(event.target).parents(".w2ui-map-field"),
                                                    f = e.attr("data-key"),
                                                    g = e.find(".key").val(),
                                                    h = e.find(".value").val(),
                                                    i = {},
                                                    ...
                                                    k = null,
                                                    l = null;
                                                i[g] = h, "array" == b.type && (c.forEach(function(a, b) {
                                                    a.key == f && (l = b)
                                                }), k = c[l]), null != f && "map" == b.type && (j[f] = c[f]), null != f && "array" == b.type && (j[f] = k.value);
                                                var m = a.trigger({
                                                    phase: "before",
                                                    target: b.field,
                                                    type: "change",
                                                ...
                                                if (m.isCancelled !== !0) {
                                                    if ("map" == b.type) {
                                                        delete c[f];
                                                        var n = c._order.indexOf(f);
                                                        if ("" != g) {
                                                            if (null != c[g]) {
                                                                var o, p = 0;
                                                                do p++, o = g + p; while (null != c[o]);
                                                                g = o, e.find(".key").val(o)
                                                            }
                                                            c[g] = h, e.attr("data-key", g), n != -1 ? c._order[n] = g : c._order.push(g)
                                                        } else c._order.splice(n, 1), e.find(".value").val("")
                                                    } else "array" == b.type && ("" != g ? null == k ? c.push({
                                                        key: g,
                                                        value: h
                                                    }) : (k.key = g, k.value = h) : c.splice(l, 1));
                                                    a.setValue(b.field, c), b.el.mapRefresh(c, d), a.trigger($.extend(m, {
                                                        phase: "after"
                                                    }))
                                                }
                                            })
                                        }, b.el.mapRefresh(i, $(b.el).parent().find(".w2ui-map-container"))
                                    }(this, f);
                                break;
                            case "radio":
                                $(f.$el).prop("checked", !1).each(function(a, b) {
                                    $(b).val() == i && $(b).prop("checked", !0)
                                });
                                break;
                            case "checkbox":
                                $(f.el).prop("checked", !!i), f.disabled !== !0 && f.disabled !== !1 || $(f.el).prop("disabled", !!f.disabled);
                                break;
                            case "html":
                            case "custom":
                            case "empty":
                                break;
                            default:
                                $(f.el).val(i), $(f.el).w2field($.extend({}, f.options, {
                                    type: f.type
                                }))
                        }
                    }
                    for (var g = $(this.box).find(".w2ui-page"), m = 0; m < g.length; m++) $(g[m]).find("> *").length > 1 && $(g[m]).wrapInner("<div></div>");
        ...
        render: function(a) {
            ...
            if ("object" == typeof a && ($(this.box).find("#form_" + this.name + "_tabs").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-form").html(""), this.box = a), this.isGenerated && this.box) {
                ...
                if (d.isCancelled !== !0) {
                    var e = '<div class="w2ui-form-box">' + ("" !== this.header ? '<div class="w2ui-form-header">' + this.header + "</div>" : "") + '    <div id="form_' + this.name + '_toolbar" class="w2ui-form-toolbar" style="display: none"></div>    <div id="form_' + this.name + '_tabs" class="w2ui-form-tabs" style="display: none"></div>' + this.formHTML + "</div>";
                    $(this.box).attr("name", this.name).addClass("w2ui-reset w2ui-form").html(e), $(this.box).length > 0 && ($(this.box)[0].style.cssText += this.style), "function" != typeof this.toolbar.render && (this.toolbar = $().w2toolbar($.extend({}, this.toolbar, {
                        name: this.name + "_toolbar",
                        owner: this
                        ...
                        b.isCancelled !== !0 && c.trigger($.extend(b, {
                            phase: "after"
                        }))
                        ...
                        c.goto(this.get(a.target, !0))
                    })), "object" == typeof this.tabs && "function" == typeof this.tabs.render && (this.tabs.render($("#form_" + this.name + "_tabs")[0]), this.tabs.active && this.tabs.click(this.tabs.active)), this.trigger($.extend(d, {
                        phase: "after"
                    })), this.resize();
                    var f = "object" != typeof this.url ? this.url : this.url.get;
                    return f && 0 !== this.recid && null != this.recid ? this.request() : this.refresh(), 0 === $(".w2ui-layout").length && (this.tmp_resize = function(a) {
                        w2ui[c.name].resize()
                    }, $(window).off("resize", "body").on("resize", "body", this.tmp_resize)), this.focus != -1 && setTimeout(function() {
                        0 === $(c.box).find("input, select, textarea").length ? setTimeout(focusEl, 500) : c.applyFocus()
                    }, 50), (new Date).getTime() - b
                }
            }
        },
        applyFocus: function() {
            for (var a = this.focus, b = $(this.box).find("div:not(.w2ui-field-helper) > input, select, textarea, div > label:nth-child(1) > :radio").not(".file-input"); $(b[a]).is(":hidden") && b.length >= a;) a++;
            b[a] && b[a].focus()
        },
        destroy: function() {
            var a = this.trigger({
